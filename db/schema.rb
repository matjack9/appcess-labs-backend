...
ActiveRecord::Schema.define(version: 20180405020825) do
  ...
  create_table "contracts_technologies", force: :cascade do |t|
  ...
  create_table "schools_technologies", force: :cascade do |t|
    t.integer "school_id"
    t.integer "technology_id"
  end
